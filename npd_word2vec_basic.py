...
input_filename = '/abinitio/dev/data/ml/navclass_training_set_US_retailers_and_unclaimed_20160318_v2.dat'
...
joblib.dump(dictionary,'/abinitio/dev/data/ml/embed_pkl/dictionary.pkl')
#joblib.dump(data,'/abinitio/dev/data/ml/embed_pkl/data.pkl')
#joblib.dump(count,'/abinitio/dev/data/ml/embed_pkl/count.pkl')
#joblib.dump(reverse_dictionary,'/abinitio/dev/data/ml/embed_pkl/reverse_dictionary.pkl')
...
with tf.Session(graph=graph) as session:
  ...
  saver.save(session,'/abinitio/dev/data/ml/embed_all/embeddings.ckpt')
