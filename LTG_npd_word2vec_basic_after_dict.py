...
print("unpickling the token dict & reverse dict")
dictionary = joblib.load(dict_dir + 'dictionary.pkl')
reverse_dictionary = joblib.load(dict_dir + 'reverse_dictionary.pkl')
count = joblib.load(dict_dir + 'count.pkl')
data = joblib.load(dict_dir + 'data.pkl')
...
with tf.Session(graph=graph) as session:
  ...
  saver.save(session,model_dir+'embeddings.ckpt')
